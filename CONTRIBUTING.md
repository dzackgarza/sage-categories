...
| `POL-KERNEL-026` | Propagate each property-subcategory constructor through selected subcategory monomorphisms, following Sage's `with_axiom` model. Build the descendant refinement, role MRO, constructor, and inherited predicate behavior generically. A leaf supplies no propagation machinery. |
