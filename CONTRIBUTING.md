...
| `POL-API-025` | A category writes `ObjectType`, `ElementType`, and `MorphismType` directly. The kernel fills the bases of those same classes. The public API and the declaration use one name for each mathematical kind. |
