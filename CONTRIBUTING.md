...
| `POL-KERNEL-036` | Parse ordinary Python declarations and generated stubs with Python 3.14 `ast`. Use LibCST only for syntax-preserving migration codemods. Fixed constructor wrappers are ordinary declared functions. Use Sage introspection and wrapt for residual callable, descriptor, and signature behavior. |
