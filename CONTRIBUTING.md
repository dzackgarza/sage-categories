...
| `POL-CAT-053` | Never use explicit Python subclassing between category-owned object, element, or morphism implementations without prior user discussion and approval. Python subclassing bypasses the structural-functor framework. |
