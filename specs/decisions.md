...
**D13 (08-26, corrected 08-29, `01a04c1c-b22b-7f70-8351-6e12ca028470` 2026-08-29T08:08Z, 2026-08-29T08:42Z, 2026-08-29T09:15Z). The kernel is Sage's class-building plus private runtime state sharing.** Sage's MRO technique works.
...
If `Sets().ObjectType` holds private set data and `Posets()` defines a functor whose ordinary object action constructs a set, then a poset receives inheritance rather than methods alone.
The compiler makes the target implementation state available on the source instance without another declaration from the functor writer.
A leaf constructor never accumulates a field for every ancestor category.
...
The kernel treats functor bodies as opaque executable actions and lets Sage determine the MRO without a second path-resolution system (`01a048f6-e3f5-7e42-be2a-1f60f70ac23e` 2026-08-28T21:17Z, 2026-08-28T21:19Z, 2026-08-28T21:40Z).
