...
## Canonical objects and the classical stage
...
`G_Sets = Sets().Terminal()` is the classical stage of `Sets()`. A classical element of
...
larger of their two stages under the transition maps and returns `Unknown` otherwise;
