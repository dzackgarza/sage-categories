...
class LimitCategory[ObjectRole, ElementRole, MorphismRole](
...
class LimitSubcategory[ObjectRole, ElementRole, MorphismRole](_StaticRoles_LimitSubcategory, LimitCategory[ObjectRole, ElementRole, MorphismRole]):
    def __init__(self, diagram: Functor) -> None: ...
