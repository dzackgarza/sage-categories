...
def _retained_object_component(candidate: CategoryOfCategories.ElementType, index: CategoryOfCategories.ElementType | Hashable) -> CategoryOfCategories.ElementType: ...
def _retained_morphism_component(candidate: MorphismCategory.ObjectType, index: CategoryOfCategories.ElementType | Hashable) -> MorphismCategory.ObjectType: ...
