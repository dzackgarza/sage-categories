...
class LimitCategory[
    _ObjectRole = _StaticRoles_LimitCategory.ObjectType,
    _ElementRole = _StaticRoles_LimitCategory.ElementType,
    _MorphismRole = _StaticRoles_LimitCategory.MorphismType,
](_StaticRoles_LimitCategory, Category[[MorphismRule | tuple[MorphismCategory.ObjectType, ...]], [], _ObjectRole, _ElementRole, _MorphismRole]):
...
class LimitSubcategory[
    _ObjectRole = _StaticRoles_LimitSubcategory.ObjectType,
    _ElementRole = _StaticRoles_LimitSubcategory.ElementType,
    _MorphismRole = _StaticRoles_LimitSubcategory.MorphismType,
](_StaticRoles_LimitSubcategory, LimitCategory[_ObjectRole, _ElementRole, _MorphismRole]):
    def __init__(self, diagram: Functor) -> None: ...
