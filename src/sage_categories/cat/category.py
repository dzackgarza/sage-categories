...
class CategoryDeclaration[**MorphismData, **TwoMorphismData]:
    ...
    def EssentialImage(self, functor: Functor) -> Category:
        """Return the full replete subcategory generated by the object image of ``functor``."""
        from sage_categories.cat.images import essential_image

        return essential_image(self, functor)
