...
class CategoryOfCategories(CategoryDeclaration[[OnObject, OnMorphism], [Assignment]]):
    ...
    def construct_structural_functor[ObjectDatum, MorphismDatum](self, domain: Category, codomain: Category, object_image: Callable[[ObjectDatum], ObjectOfCategory], morphism_image: Callable[[MorphismDatum], MorphismOfCategory]) -> Functor: ...
    ...
    def Point(self, member: CategoryPoint, targets: tuple[Category, ...] = (), roles: dict[Role, type[CategoryPoint]] | None = None) -> PointCategory: ...
