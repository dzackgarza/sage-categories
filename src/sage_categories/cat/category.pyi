...
from sage_categories.kernel.refinement import is_placed as is_placed, is_retained_inclusion as is_retained_inclusion, is_subcategory as is_subcategory
...
class CategoryOfCategories(Category[[OnObject, OnMorphism], [Assignment]]):
    @property
    def ObjectType(self) -> type[Category]: ...
    @property
    def ElementType(self) -> type[CategoryPoint_elements]: ...
    @property
    def MorphismType(self) -> type[Functor]: ...
    def __init__(self) -> None: ...
    def local_role_class(self, role: Role) -> type[CategoryPoint]: ...
