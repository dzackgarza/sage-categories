...
from sage_categories.kernel.predicates import AppliedPredicate as AppliedPredicate, AppliedQuery as AppliedQuery, Axiom as Axiom, Predicate as Predicate, PropertyPredicate as PropertyPredicate, Proposition as Proposition, Query as Query, ask as ask, assume as assume
from sage_categories.kernel.roles import CategoryPoint as _CategoryPoint, ElementOfObject as ElementOfObject, MorphismOfCategory as MorphismOfCategory, ObjectOfCategory as ObjectOfCategory, Role as _Role
...
class CategoryDeclaration[**MorphismData, **TwoMorphismData](ObjectOfCategory):
    ...
    def retain_datum[Datum](self, value: _CategoryPoint, datum: Datum) -> None: ...
    def retained_datum[Datum](self, value: _CategoryPoint) -> Datum: ...
...
class CategoryOfCategories(CategoryDeclaration[[OnObject, OnMorphism], [Assignment]]):
    ...
    def construct_two_morphism(self, source: _CategoryPoint, target: _CategoryPoint, assignment: Assignment) -> NaturalTransformation: ...
    def identity_two_morphism(self, member_object: _CategoryPoint) -> NaturalTransformation: ...
    ...
    def postcompose(self, functor: Functor, diagram: _CategoryPoint) -> _CategoryPoint: ...
    ...
    def Point(self, member: _CategoryPoint, targets: tuple[Category, ...] = ()) -> PointCategory: ...
    def retained_point(self, member: _CategoryPoint) -> PointCategory | None: ...
    ...
    def element_from_defining_morphism(self, defining_functor: Functor) -> _CategoryPoint: ...
