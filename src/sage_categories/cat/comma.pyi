...
class CommaCategory[
    _ObjectRole = _StaticRoles_CommaCategory.ObjectType,
    _ElementRole = _StaticRoles_CommaCategory.ElementType,
    _MorphismRole = _StaticRoles_CommaCategory.MorphismType,
](_StaticRoles_CommaCategory, Category[[MorphismCategory.ObjectType, MorphismCategory.ObjectType], [], _ObjectRole, _ElementRole, _MorphismRole]):
...
class CommaSpecialization[
    _ObjectRole = _StaticRoles_CommaSpecialization.ObjectType,
    _ElementRole = _StaticRoles_CommaSpecialization.ElementType,
    _MorphismRole = _StaticRoles_CommaSpecialization.MorphismType,
](_StaticRoles_CommaSpecialization, CommaCategory[_ObjectRole, _ElementRole, _MorphismRole]):
