...
class FunctorDeclaration(MorphismOfCategory):
    ...
    def retain_constructor_data[SourceObjectDatum, TargetObjectDatum, SourceMorphismDatum, TargetMorphismDatum](self, object_datum: Callable[[SourceObjectDatum], TargetObjectDatum], morphism_datum: Callable[[SourceMorphismDatum], TargetMorphismDatum]) -> None: ...
