...
type LiftRule = Callable[[MorphismOfCategory, CategoryOfCategories.ElementType], MorphismOfCategory]
...
class FunctorDeclaration(MorphismOfCategory):
    ...
    def cartesian_lift(self, morphism: MorphismOfCategory, member_object: CategoryOfCategories.ElementType) -> MorphismOfCategory: ...
    def cocartesian_lift(self, morphism: MorphismOfCategory, member_object: CategoryOfCategories.ElementType) -> MorphismOfCategory: ...
