...
class FunctorDeclaration(MorphismOfCategory):
    ...
    def retain_structural_images[ObjectDatum, MorphismDatum](self, object_image: Callable[[ObjectDatum], ObjectOfCategory], morphism_image: Callable[[MorphismDatum], MorphismOfCategory]) -> None: ...
...
class FunctorProperties:
    ...
    def structural[ObjectDatum, MorphismDatum](self, object_image: Callable[[ObjectDatum], ObjectOfCategory], morphism_image: Callable[[MorphismDatum], MorphismOfCategory]) -> Functor: ...
