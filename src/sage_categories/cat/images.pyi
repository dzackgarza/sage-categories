...
class ImageCategory[
    **MorphismData,
    **TwoMorphismData,
    _ObjectRole = _StaticRoles_ImageCategory.ObjectType,
    _ElementRole = _StaticRoles_ImageCategory.ElementType,
    _MorphismRole = _StaticRoles_ImageCategory.MorphismType,
](_StaticRoles_ImageCategory, Category[MorphismData, TwoMorphismData, _ObjectRole, _ElementRole, _MorphismRole]):
