...
class MorphismCategory[
    **MorphismData,
    **TwoMorphismData,
    _ObjectRole = _StaticRoles_MorphismCategory.ObjectType,
    _ElementRole = _StaticRoles_MorphismCategory.ElementType,
    _MorphismRole = _StaticRoles_MorphismCategory.MorphismType,
](_StaticRoles_MorphismCategory, Category[TwoMorphismData, [], _ObjectRole, _ElementRole, _MorphismRole]):
    ...
    ) -> FixedEndpointCategory[MorphismData, TwoMorphismData, DomainType, CodomainType, _ObjectRole, _ElementRole, _MorphismRole]: ...
    def fixed_endpoint_type(self) -> type[FixedEndpointCategory[MorphismData, TwoMorphismData]]: ...
    def construct_identity(self, morphism: _ObjectRole) -> _ObjectRole: ...
    def composite(self, second: _ObjectRole, first: _ObjectRole) -> _ObjectRole: ...
    def construct_morphism(self, source: _ObjectRole, target: _ObjectRole, *args: TwoMorphismData.args, **kwargs: TwoMorphismData.kwargs) -> _ObjectRole: ...
...
class _StaticRoles_FixedEndpointCategory(sage_categories.cat.properties._StaticRoles_FullSubcategory):
    class ObjectType(sage_categories.cat.category._StaticRoles_CategoryOfCategories.ElementType, sage_categories.kernel.roles.ObjectOfCategory): ...
    class ElementType(sage_categories.cat.morphisms._StaticRoles_MorphismCategory.ElementType): ...

    class MorphismType(sage_categories.cat.morphisms._StaticRoles_MorphismCategory.MorphismType):
        ...
...
class FixedEndpointCategory[
    ...
    **TwoMorphismData,
    ...
    _ElementRole = _StaticRoles_MorphismCategory.ElementType,
    _MorphismRole = _StaticRoles_MorphismCategory.MorphismType,
](_StaticRoles_FixedEndpointCategory, FullSubcategory[TwoMorphismData, [], _ObjectRole, _ElementRole, _MorphismRole]):
    ...
    def compose(self, second: MorphismCategory.ObjectType, first: MorphismCategory.ObjectType) -> _ObjectRole: ...
