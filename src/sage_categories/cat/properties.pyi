...
from sage_categories.cat.category import AppliedPredicate as AppliedPredicate, Category as Category, CategoryPoint as CategoryPoint, ElementOfObject as ElementOfObject, MorphismOfCategory as MorphismOfCategory, PropertyPredicate as PropertyPredicate, Proposition as Proposition, Role as Role, is_subcategory as is_subcategory, member as member, refine as refine
...
class NarrowedProperty[**MorphismData, **TwoMorphismData](FullSubcategory[MorphismData, TwoMorphismData]):
    @property
    def ObjectType(self) -> type[CategoryPoint]: ...
    @property
