...
class PropertySubcategory[**MorphismData, **TwoMorphismData](FullSubcategory[MorphismData, TwoMorphismData]):
    ...
    @overload
    def intersection(self, other: PropertySubcategory[MorphismData, TwoMorphismData]) -> Category[MorphismData, TwoMorphismData]: ...
    @overload
    def intersection(self, other: tuple[Category[MorphismData, TwoMorphismData], ...]) -> Category[MorphismData, TwoMorphismData]: ...
    def structure_functors(self) -> tuple[Functor, ...]: ...
    def membership_proposition(self, candidate: CategoryOfCategories.ElementType) -> Proposition: ...
