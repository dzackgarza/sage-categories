...
class ThinCategory[
    ObjectRole = _StaticRoles_ThinCategory.ObjectType,
    ElementRole = _StaticRoles_ThinCategory.ElementType,
    MorphismRole = _StaticRoles_ThinCategory.MorphismType,
](_StaticRoles_ThinCategory, Category[[], [], ObjectRole, ElementRole, MorphismRole]):
