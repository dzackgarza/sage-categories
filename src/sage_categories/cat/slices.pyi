...
class SliceProperty[
    _ObjectRole = _StaticRoles_SliceProperty.ObjectType,
    _ElementRole = _StaticRoles_SliceProperty.ElementType,
    _MorphismRole = _StaticRoles_SliceProperty.MorphismType,
](_StaticRoles_SliceProperty, FullSubcategory[[MorphismCategory.ObjectType], [], _ObjectRole, _ElementRole, _MorphismRole]):
