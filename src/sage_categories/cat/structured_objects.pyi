...
class _StaticRoles_InserterCategory(sage_categories.cat.cat_constructions._StaticRoles_LimitSubcategory):
    class ObjectType(_StaticRoles_MagmaCategory.ObjectType, sage_categories.cat.cat_constructions._StaticRoles_LimitCategory.ObjectType):
        def carrier(self) -> CategoryOfCategories.ElementType: ...
        def structure(self) -> MorphismCategory.ObjectType: ...

    class ElementType(_StaticRoles_MagmaCategory.ElementType, sage_categories.cat.cat_constructions._StaticRoles_LimitCategory.ElementType): ...

    class MorphismType(_StaticRoles_MagmaCategory.MorphismType, sage_categories.cat.cat_constructions._StaticRoles_LimitCategory.MorphismType):
