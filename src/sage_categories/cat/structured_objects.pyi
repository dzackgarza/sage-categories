...
class _StaticRoles_EquifierCategory(sage_categories.cat.properties._StaticRoles_FullSubcategory):
    class ObjectType(
        sage_categories.cat.cat_constructions.LimitCategory.ObjectType,
        sage_categories.sets.finite.SetsCategory.ObjectType,
        sage_categories.cat.constructions.LimitsCategory.ElementType,
    ): ...
...
class _StaticRoles_AdditiveMagmasCategory(_StaticRoles_NamedOperationCategory):
    class ObjectType(
        ...
        sage_categories.sets.finite.SetsCategory.ObjectType,
        sage_categories.cat.constructions.LimitsCategory.ElementType,
        sage_categories.cat.constructions.ProductsCategory.ElementType,
    ):
...
class _StaticRoles_MonoidPairsCategory(sage_categories.cat.cat_constructions._StaticRoles_LimitSubcategory):
    class ObjectType(
        sage_categories.cat.properties.InverseImageSubcategory.ObjectType,
        sage_categories.cat.structured_objects.MultiplicativeMonoidsCategory.ObjectType,
        sage_categories.cat.structured_objects.AdditiveMonoidsCategory.ObjectType,
    ): ...
    class ElementType(
        sage_categories.cat.properties.InverseImageSubcategory.ElementType,
        sage_categories.cat.structured_objects.MultiplicativeMonoidsCategory.ElementType,
        sage_categories.cat.structured_objects.AdditiveMonoidsCategory.ElementType,
    ): ...

    class MorphismType(
        sage_categories.cat.properties.InverseImageSubcategory.MorphismType,
        sage_categories.cat.structured_objects.MultiplicativeMonoidsCategory.MorphismType,
        sage_categories.cat.structured_objects.AdditiveMonoidsCategory.MorphismType,
    ):
        ...
