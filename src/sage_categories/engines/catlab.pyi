...
__all__ = ['ensure_native_category', 'ensure_native_functor', 'functor_object_image', 'functor_morphism_image', 'compose_functors', 'retain_composite_functor', 'identity_functor', 'callable_transformation', 'ensure_native_transformation', 'transformation_component', 'identity_transformation', 'compose_transformations', 'whisker_left', 'whisker_right', 'horizontal_composite', 'presented_coproduct', 'presented_coproduct_data', 'presented_coproduct_object_image', 'presented_coproduct_path_image', 'presented_functor', 'presented_functor_morphism_image']
...
def compose_transformations(value: MorphismCategory.ObjectType, first: MorphismCategory.ObjectType, second: MorphismCategory.ObjectType, source: MorphismCategory.ObjectType, target: MorphismCategory.ObjectType) -> None:
    ...

def whisker_left(value: MorphismCategory.ObjectType, functor: MorphismCategory.ObjectType, transformation: MorphismCategory.ObjectType, source: MorphismCategory.ObjectType, target: MorphismCategory.ObjectType) -> None:
    ...

def whisker_right(value: MorphismCategory.ObjectType, transformation: MorphismCategory.ObjectType, functor: MorphismCategory.ObjectType, source: MorphismCategory.ObjectType, target: MorphismCategory.ObjectType) -> None:
    ...

def horizontal_composite(value: MorphismCategory.ObjectType, first: MorphismCategory.ObjectType, second: MorphismCategory.ObjectType, source: MorphismCategory.ObjectType, target: MorphismCategory.ObjectType) -> None:
    ...
