...
def retain_whisker_left(
    owner: Category, value: MorphismCategory.ObjectType, functor: MorphismCategory.ObjectType, transformation: MorphismCategory.ObjectType
) -> homotopy.Cell: ...
def retain_whisker_right(
    owner: Category, value: MorphismCategory.ObjectType, transformation: MorphismCategory.ObjectType, functor: MorphismCategory.ObjectType
) -> homotopy.Cell: ...
