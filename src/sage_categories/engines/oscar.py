...
def prime_ideal(ring: object, generators: tuple[object, ...]) -> object:
    ...
    return bridge().prime_ideal_from_generators(ring, list(generators))


def prime_ideal_preimage(mapping: object, prime: object) -> object:
    """Return the inverse-image prime ideal under ``mapping``."""
    return bridge().prime_ideal_preimage(mapping, prime)
...
def localization_at_prime(ring: object, prime: object) -> tuple[object, object]:
    ...
    localized, canonical = bridge().localization_at_prime(ring, prime)
    return localized, canonical


def stalk_map(
    mapping: object,
    source_localized: object,
    target_localized: object,
    target_localization: object,
) -> object:
    """Return the induced local homomorphism on prime localizations."""
    return bridge().stalk_map(mapping, source_localized, target_localized, target_localization)
