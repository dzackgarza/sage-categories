...
class PositiveIntegersCategory(CategoryDeclaration[[Rule], []]):
    @property
    def ObjectType(self) -> type[PositiveIntegerSet]: ...
    @property
    def ElementType(self) -> type[PositiveIntegersCategory.DeclaredElementType]: ...
    @property
    def MorphismType(self) -> type[PositiveIntegersCategory.DeclaredMorphismType]: ...
