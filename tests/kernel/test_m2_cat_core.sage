...
test_point_category_uses_generic_empty_structure_surface()
test_the_three_role_types_a_functor_and_a_transformation_are_one_tower()
test_functors_and_two_morphisms_are_owned_and_distinct()
test_walking_arrow_evaluation_acts_on_objects_and_two_morphisms()
test_products_pullbacks_comma_and_fixed_slices_retain_defining_functors()
test_shape_indexed_functor_properties_exist_at_fixed_endpoints()
test_op_is_an_involution_on_the_four_kinds_it_acts_on()
test_the_narrowing_join_of_two_dual_placements_compiles()
test_one_equality_predicate_has_a_generic_case_and_one_exact_owner()
test_a_composite_is_placed_by_both_of_its_factors()
test_canonical_shapes_are_retained()
test_the_zero_argument_declaration_states_the_property_category_it_names()
test_a_functor_is_its_exact_endpoints_and_its_two_ordinary_actions()
test_a_natural_transformation_is_a_morphism_of_its_exact_functor_category()
test_the_containments_of_funs_property_subcategories_are_retained_monomorphisms()
test_an_axiom_parameterized_by_a_functor_is_the_essential_image()
...
test_the_restriction_of_a_functor_places_its_images_in_the_core_it_was_declared_into()
