...
def free_associative_types(
    ...
    assert_type(free_associative_generator(algebra, 0), CategoryOfCategories.ElementType)
    assert_type(free_associative_product(algebra, element, element), CategoryOfCategories.ElementType)
